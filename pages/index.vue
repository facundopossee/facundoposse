  ...
  <div class="container">
    <div class="px-5">
      <div class="flex flex-col">
        <div class="content-start h-6 w-6 pt-5">
          <transition name="fade">
            <img v-show="icons" src="../assets/img/code.png" />
          </transition>
        </div>
        <div class="central">
          <div class="p-5">
            <h1 class="lg:text-5xl md:text-4xl sm:text-3xl font-bold">
              <Typer
                class="text1"
            ...
            <h1 class="lg:text-4xl md:text-3xl sm:text-2xl font-bold">
              <Typer
                class="text2"
                v-show="show"
